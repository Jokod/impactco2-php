...
class TransportsEnum
{
    ...
    public static $names = [
        ...
        self::CAR                   => 'Voiture thermique',
        self::ELECTRIC_CAR          => 'Voiture électrique',
        self::BUS                   => 'Autocar thermique',
        self::BIKE                  => 'Vélo',
        self::ELECTRIC_BIKE         => 'Vélo à assistance électrique',
        self::THERMAL_BUS           => 'Bus thermique',
        self::TRAMWAY               => 'Tramway',
        self::METRO                 => 'Métro',
        self::SCOOTER               => 'Scooter thermique',
        self::MOTORCYCLE            => 'Moto thermique (> 250 cm³)',
        self::RER_TRANSILIEN        => 'RER ou Transilien',
        self::TER                   => 'TER',
        self::ELECTRIC_BUS          => 'Bus électrique',
        self::ELECTRIC_SCOOTER      => 'Trottinette à assistance électrique',
        self::GNV_BUS               => 'Bus (GNV)',
        self::CARPOOLING_1          => 'Covoiturage thermique (2 personnes)',
        self::CARPOOLING_2          => 'Covoiturage thermique (3 personnes)',
        self::CARPOOLING_3          => 'Covoiturage thermique (4 personnes)',
        self::CARPOOLING_4          => 'Covoiturage thermique (5 personnes)',
        self::ELECTRIC_CARPOOLING_1 => 'Covoiturage électrique (2 personnes)',
        self::ELECTRIC_CARPOOLING_2 => 'Covoiturage électrique (3 personnes)',
        self::ELECTRIC_CARPOOLING_3 => 'Covoiturage électrique (4 personnes)',
        self::ELECTRIC_CARPOOLING_4 => 'Covoiturage électrique (5 personnes)',
        self::WALKING               => 'Marche',
